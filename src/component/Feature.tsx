    ...
    <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 mb-30">
      ...
      <div className="max-w-xl mx-auto text-center mt-24">
        ...
        <p className="text-gray-500">
            Jfive Digital menyediakan layanan pengembangan perangkat lunak dan konsultasi TI menyeluruh untuk membantu bisnis membangun, mengelola, dan meningkatkan skala produk digital mereka secara efisien.
        </p>
      </div>
