    ...
    <div className="bg-primary">
      <div className="mt-14 mb-3 lg:mb-32 max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
        ...
        >
          ...
          >
            Jfive Digital adalah perusahaan perangkat lunak dan mitra konsultasi TI yang memberikan solusi inovatif untuk mendorong efisiensi, pertumbuhan, dan transformasi digital.
          </p>
          ...
          >
            <a
              href="https://wa.me/6283824723921?text=Halo%20kak,%20saya%20ingin%20buat%20project%20bersama%Jfive%20Digital%20Tech,%20apakah%20bisa%20di%20bantu%3F"
            ...
            <div className="flex items-center justify-center space-x-3 transition hover:scale-110 md:justify-start">
              ...
              <span className="text-gray-200">Lihat Pekerjaan Kami</span>
            </div>
          </div>
        </div>
